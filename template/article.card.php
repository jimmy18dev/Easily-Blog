<article class="article-card">
	<header class="<?php echo (empty($var['cover_id'])?'fullsize':'');?>">
		<h2><a href="article/<?php echo $var['id'];?>/<?php echo $var['url'];?>#article"><?php echo (!empty($var['title'])?$var['title']:'Untitle');?></a></h2>
	...
	<figure class="thumbnail">
		<a href="article/<?php echo $var['id'];?>/<?php echo $var['url'];?>#article">
